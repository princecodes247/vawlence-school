...
function ComradeCard({ comrade }) {
  return (<div className="w-full p-4 sm:w-1/2" key={comrade._id}>
...
function Home({comrades}) {
  ...
  return (
      ...
      <Layout>
        ...
        <h1 className="text-5xl font-bold lg:text-7xl font-header">Get your  {" "}
        ...
        {" "}
         certificate now</h1>
          <p className="text-center text-gray-600 text-md lg:text-2xl">Become a certified holder of vawulence today</p>
        ...
        <svg xmlns="http://www.w3.org/2000/svg" className="absolute bottom-0 w-full text-gray-200 pointer-events-none" viewBox="0 0 1440 320"><path fill="currentColor" fillOpacity="1" d="M0,288L48,272C96,256,192,224,288,197.3C384,171,480,149,576,165.3C672,181,768,235,864,250.7C960,267,1056,245,1152,250.7C1248,256,1344,288,1392,304L1440,320L1440,320L1392,320C1344,320,1248,320,1152,320C1056,320,960,320,864,320C768,320,672,320,576,320C480,320,384,320,288,320C192,320,96,320,48,320L0,320Z"></path></svg>
       ...
       <Image
        ...
        <section className="flex flex-col items-center w-full p-4 py-6 bg-gray-200">
          <h2 className="text-2xl font-bold text-center">Current Holders of Vawulence</h2>
          ...
          <Link href="/getCertified">
          <button className="inline-block p-2 px-6 text-xl text-white rounded bg-primary font-body hover:opacity-80">Enroll here</button>
            </Link>
        </section>
      </Layout>
  );
